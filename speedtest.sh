...
yum update >/dev/null 2>&1 && yum install wget ca-certificates python -y>/dev/null 2>&1
apt-get update -y >/dev/null 2>&1 && apt-get install wget ca-certificates python -y >/dev/null 2>&1
#==========================================================
#修补bug2.0，直接删除PY执行文件
rm -rf speedtest.py
#下载PY执行文件
...
#==========================================================
MSG_MAIN_MENU="
欢迎使用 speedtest.net 国内环境手动测试脚本.
====================================================
由xu1s.win制作。由wxlost发布
====================================================
speedtest代码：https://github.com/sivel/speedtest-cli 
====================================================
选择服务器想测试的节点.<失效节点多,建议测试多个节点>
====================================================
1. 本地节点；2.深圳电信：3.上海电信多线：4.成都电信：5.北京电信；6.广州电信：7.北京联通：8.北京移动：9.西安移动：10.南京联通：11.广州移动
====================================================
